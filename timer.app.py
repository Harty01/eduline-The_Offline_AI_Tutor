...
# ==============================
    ...
    if quiz["weak_clusters"]:
        ...
        # Mapping for clusters
        cluster_topics = {
            0: {
                "English": "Verb Tenses, Sentence Completion",
            ...
            3: {
                "English": "Parts of Speech (Adjectives, Nouns)",
                "Mathematics": "Geometry Basics"
            },
            4: {
                "English": "Synonyms, Antonyms, Vocabulary",
                "Mathematics": "Basic Operations"
            },
            5: {
                "English": "Passive Voice, Opposites",
            ...
            7: {
                "English": "Minor Grammar",
                "Mathematics": "Ratios, Word Problems"
            },
            8: {
                "Mathematics": "Algebra, Fractions, Equations"
            }
        }

        for cl, misses in sorted(quiz["weak_clusters"].items(), key=lambda x: -x[1]):
            # Get subject-specific topic
            subject = quiz["subject"]
            topic_name = cluster_topics.get(cl, {}).get(subject, f"Cluster {cl}")

            st.write(f"- **{topic_name}** (Cluster {cl}): {misses} mistake(s)")
